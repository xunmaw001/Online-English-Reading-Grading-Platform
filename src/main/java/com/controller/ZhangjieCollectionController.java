...
public class ZhangjieCollectionController {
    ...
    private static final String TABLE_NAME = "zhangjieCollection";
    ...
    */
    ...
    public R update(@RequestBody ZhangjieCollectionEntity zhangjieCollection, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,zhangjieCollection:{}",this.getClass().getName(),zhangjieCollection.toString());
        ZhangjieCollectionEntity oldZhangjieCollectionEntity = zhangjieCollectionService.selectById(zhangjieCollection.getId());//查询原先数据
...
//            zhangjieCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<ZhangjieCollectionEntity> oldZhangjieCollectionList =zhangjieCollectionService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                    youlanjiluService.insertYoulanjilu((Integer) request.getSession().getAttribute("userId"),TABLE_NAME,zhangjie.getId(),zhangjie.getZhangjieName(),null);
                return R.ok().put("data", view);
            }else {
                return R.error(511,"查不到数据");
            }
    ...
    */
    ...
    public R add(@RequestBody ZhangjieCollectionEntity zhangjieCollection, HttpServletRequest request){
        ...
        Wrapper<ZhangjieCollectionEntity> queryWrapper = new EntityWrapper<ZhangjieCollectionEntity>()
            ...
            .eq("yonghu_id", zhangjieCollection.getYonghuId())
            .eq("zhangjie_collection_types", zhangjieCollection.getZhangjieCollectionTypes())
//            .notIn("zhangjie_collection_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        ZhangjieCollectionEntity zhangjieCollectionEntity = zhangjieCollectionService.selectOne(queryWrapper);
        if(zhangjieCollectionEntity==null){
