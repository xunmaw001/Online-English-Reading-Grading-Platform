    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评论内容" prop="shujiLiuyanText">
                        <el-input type="textarea"  :readonly="ro.shujiLiuyanText" v-model="ruleForm.shujiLiuyanText" placeholder="评论内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shujiLiuyanText" label="评论内容" prop="shujiLiuyanText">
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                ...
                this.ro.shujiLiuyanText = true;//评论内容
            }else{
            }
