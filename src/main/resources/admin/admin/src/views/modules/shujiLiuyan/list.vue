                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zaixianyingyuyuedupingtai/upload/shujiLiuyanMuBan.xls"
                        >批量导入书籍评论数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shujiLiuyan','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      ...
                                      label="评论内容">
                        <template slot-scope="scope">
                            <span v-if="scope.row.shujiLiuyanText != null &&scope.row.shujiLiuyanText.length>10">
                                {{scope.row.shujiLiuyanText.slice(0,10)}}...
                            </span>
                            <span v-else>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'shuji_liuyan',//当前表表名,
                        sumColum : 'shuji_liuyan_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'shuji_liuyan_name',//分组字符串字段
                        // types : 'shuji_liuyan_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "shuji_liuyan_types",
                //// riqi :getMonthFormat(_this.echartsDate),//年月
                //     }
                //     this.$http({
            ...
            wuyong(id) {
                ...
                _this.$confirm(`确定    操作?`, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"
                    ...
                    _this.$http({
                        url: "shujiLiuyan/update",
                        method: "post",
                        data: {
                            id:id,
//                            shujiLiuyanTypes:shujiLiuyanTypes,
                        }
                    }).then(({data}) => {
                        if(data && data.code === 0){
