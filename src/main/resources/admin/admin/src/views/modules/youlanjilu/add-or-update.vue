    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="游览表id" prop="youlanTableid">
                       <el-input v-model="ruleForm.youlanTableid"
                                 placeholder="游览表id" clearable  :readonly="ro.youlanTableid"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="游览表id" prop="youlanTableid">
                           <el-input v-model="ruleForm.youlanTableid"
                                     placeholder="游览表id" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="游览表名称" prop="youlanTablename">
                       <el-input v-model="ruleForm.youlanTablename"
                                 placeholder="游览表名称" clearable  :readonly="ro.youlanTablename"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="游览表名称" prop="youlanTablename">
                           <el-input v-model="ruleForm.youlanTablename"
                                     placeholder="游览表名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="名称" prop="youlanName">
                       <el-input v-model="ruleForm.youlanName"
                                 placeholder="名称" clearable  :readonly="ro.youlanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="名称" prop="youlanName">
                           <el-input v-model="ruleForm.youlanName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.youlanPhoto" label="图片" prop="youlanPhoto">
                        <file-upload
                            tip="点击上传图片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.youlanPhoto?$base.url+ruleForm.youlanPhoto:''"
                            @change="youlanPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.youlanPhoto" label="图片" prop="youlanPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.youlanPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   youlanTableid: [
                              { required: true, message: '游览表id不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   youlanTablename: [
                              { required: true, message: '游览表名称不能为空', trigger: 'blur' },
                          ],
                   youlanName: [
                   ...
                   insertTime: [
                              { required: true, message: '游览时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`youlanjilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.youlanjiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            youlanPhotoUploadChange(fileUrls){
                this.ruleForm.youlanPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
