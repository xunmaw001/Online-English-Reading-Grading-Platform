    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='shuji' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shujiPhoto" label="书籍封面" prop="shujiPhoto">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shujiPhoto" label="书籍封面" prop="shujiPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='shuji' ">
                    <el-form-item class="input" v-if="type!='info'"  label="二级类型" prop="shujiErjiValue">
                        <el-input v-model="shujiForm.shujiErjiValue"
                                  placeholder="二级类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="二级类型" prop="shujiErjiValue">
                            <el-input v-model="ruleForm.shujiErjiValue"
                                      placeholder="二级类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shuji' ">
                    <el-form-item class="input" v-if="type!='info'"  label="书籍热度" prop="shujiClicknum">
                        <el-input v-model="shujiForm.shujiClicknum"
                                  placeholder="书籍热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="书籍热度" prop="shujiClicknum">
                            <el-input v-model="ruleForm.shujiClicknum"
                                      placeholder="书籍热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="shujiId" name="shujiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="章节标题" prop="zhangjieName">
                       <el-input v-model="ruleForm.zhangjieName"
                                 placeholder="章节标题" clearable  :readonly="ro.zhangjieName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="章节标题" prop="zhangjieName">
                           <el-input v-model="ruleForm.zhangjieName"
                                     placeholder="章节标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="序号" prop="zhangjieXuhao">
                       <el-input v-model="ruleForm.zhangjieXuhao"
                                 placeholder="序号" clearable  :readonly="ro.zhangjieXuhao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="序号" prop="zhangjieXuhao">
                           <el-input v-model="ruleForm.zhangjieXuhao"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.zhangjieContent"  label="章节内容" prop="zhangjieContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zhangjieClicknum: [
                              { required: true, message: '章节热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.zhangjieContent = _this.ruleForm.zhangjieContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.zhangjieContent = this.ruleForm.zhangjieContent.replaceAll(this.$base.url,"");
                        this.$http({
